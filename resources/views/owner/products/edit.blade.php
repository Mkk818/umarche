          ...
          <form method="POST" action="{{ route('owner.products.update', ['product' => $product->id ])}}">
            ...
            <div class="-m-2">
              ...
              <div class="relative flex justify-evenly">
                <div>
                  <input type="radio" name="type" value="1" class="mr-2" @if($product->is_selling === 1){checked }
                  @endif>追加
                </div>
                <div>
                  <input type="radio" name="type" value="2" class="mr-2" @if($product->is_selling === 0){checked }
                  @endif>削減
                </div>
              </div>
              <div class="p-2 w-1/2 mx-auto">
