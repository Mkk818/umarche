          ...
          <div class="lg:flex lg:justify-around">
            <div class="lg:flex items-center">
              ...
              <div class="flex space-x-2 items-center">
                <div><input class="border border-gray-500 py-2"  name="keyword" placeholder="キーワードを入力"></div>
            ...
            <div>
              ...
              <select name="sort" id="sort" class="mr-4">
                ...
                @if (\Request::get('sort') === \Constant::SORT_ORDER['lowerPrice']) selected @endif>価格の安い順
                </option>
